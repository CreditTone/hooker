...
function loadXinitDexfile(dexfile) {
    loadDexfile('/data/user/0/com.alibaba.wireless/xinit/'+dexfile);
};
...
var mockerClass = "gz.alibaba.MockApi";
...
function getProductDetail(productId) {
    Java.perform(function() {
        var SearchUIMockerClz = Java.use(mockerClass);
        var result = SearchUIMockerClz.getProductDetail(productId);
        log(fastTojson(result));
    });
}

function getDistributionProductDetail(productId) {
    Java.perform(function() {
        var SearchUIMockerClz = Java.use(mockerClass);
        var result = SearchUIMockerClz.getDistributionProductDetail(productId);
        log(fastTojson(result));
    });
}
