...
//com.meitu.meipaimv.community.statistics.exposure.e:handleMessage
...
//com.meitu.meipaimv.community.statistics.exposure.e:handleMessage
Java.perform(function() {
    var com_meitu_meipaimv_community_statistics_exposure_e_clz = Java.use('com.meitu.meipaimv.community.statistics.exposure.e');
    var com_meitu_meipaimv_community_statistics_exposure_e_clz_method_handleMessage_8044 = com_meitu_meipaimv_community_statistics_exposure_e_clz.handleMessage.overload('android.os.Message');
    com_meitu_meipaimv_community_statistics_exposure_e_clz_method_handleMessage_8044.implementation = function(v0) {
    	log("what="+v0.what.value);
    	log("obj="+getClassName(v0.obj.value));
        var executor = this.hashCode();
        var beatText = 'public void com.meitu.meipaimv.community.statistics.exposure.e.handleMessage(android.os.Message)';
        var beat = newMethodBeat(beatText, executor);
        com_meitu_meipaimv_community_statistics_exposure_e_clz_method_handleMessage_8044.call(this, v0);
        printBeat(beat);
    };
});
