...
//com.meitu.iap.core.util.SigTool
...
//com.meitu.iap.core.util.SigTool
Java.perform(function() {
    var com_meitu_iap_core_util_SigTool_clz = Java.use('com.meitu.iap.core.util.SigTool');
    var com_meitu_iap_core_util_SigTool_clz_method_createSigEntity_1188 = com_meitu_iap_core_util_SigTool_clz.createSigEntity.overload('java.lang.String', 'java.util.HashMap', 'android.content.Context');
    com_meitu_iap_core_util_SigTool_clz_method_createSigEntity_1188.implementation = function(v0, v1, v2) {
    	log("v0:"+v0);
    	log("v1 class:"+getClassName(v1));
    	log("v1 json:"+fastTojson(v1));
    	log("v2 class:"+getClassName(v2));
        var executor = 'Class';
        var beatText = 'public static void com.meitu.iap.core.util.SigTool.createSigEntity(java.lang.String,java.util.HashMap,android.content.Context)';
        var beat = newMethodBeat(beatText, executor);
        com_meitu_iap_core_util_SigTool_clz_method_createSigEntity_1188.call(com_meitu_iap_core_util_SigTool_clz, v0, v1, v2);
        printBeat(beat);
    };
});
