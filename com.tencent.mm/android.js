...
function findViewById(viewId) {
    ...
    Java.perform(function() {
        ...
        var getViewInfoMehtod = radarAndroidClz.getViewInfo.overload('java.lang.Object');
        var viewInfo = getViewInfoMehtod.call(radarAndroidClz, viewId+"");
...
function searchText(idName, keyword) {
    Java.perform(function() {
        var androidUIClz = Java.use("gz.radar.AndroidUI");
        var searchText = androidUIClz.searchText.overload("java.lang.String", "java.lang.String");
        searchText.call(androidUIClz, idName, keyword);
    });
}
