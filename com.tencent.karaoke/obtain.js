...
Java.perform(function() {
    ...
    //下面是生成的代码
    var android_os_Parcel_clz = Java.use('android.os.Parcel');
    var android_os_Parcel_clz_method_obtain_fedf = android_os_Parcel_clz.obtain.overload('int');
    android_os_Parcel_clz_method_obtain_fedf.implementation = function(v0) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        var ret = android_os_Parcel_clz_method_obtain_fedf.call(android_os_Parcel_clz, v0);
        methodInBeat(invokeId, startTime, 'protected static final android.os.Parcel android.os.Parcel.obtain(int)', executor);
        return ret;
    };
    var android_os_Parcel_clz_method_obtain_uell = android_os_Parcel_clz.obtain.overload('long');
    android_os_Parcel_clz_method_obtain_uell.implementation = function(v0) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        var ret = android_os_Parcel_clz_method_obtain_uell.call(android_os_Parcel_clz, v0);
        methodInBeat(invokeId, startTime, 'protected static final android.os.Parcel android.os.Parcel.obtain(long)', executor);
        return ret;
    };
    var android_os_Parcel_clz_method_obtain_n2np = android_os_Parcel_clz.obtain.overload();
    android_os_Parcel_clz_method_obtain_n2np.implementation = function() {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        var ret = android_os_Parcel_clz_method_obtain_n2np.call(android_os_Parcel_clz);
        methodInBeat(invokeId, startTime, 'public static android.os.Parcel android.os.Parcel.obtain()', executor);
        return ret;
    };
});