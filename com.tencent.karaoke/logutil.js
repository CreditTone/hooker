...
Java.perform(function() {
    ...
    var filter = "\.mp4";
    //下面是生成的代码
    var com_tencent_component_utils_LogUtil_clz = Java.use('com.tencent.component.utils.LogUtil');
    var com_tencent_component_utils_LogUtil_clz_method_i_hmd5 = com_tencent_component_utils_LogUtil_clz.i.overload('java.lang.String', 'java.lang.String');
    com_tencent_component_utils_LogUtil_clz_method_i_hmd5.implementation = function(v0, v1) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        com_tencent_component_utils_LogUtil_clz_method_i_hmd5.call(com_tencent_component_utils_LogUtil_clz, v0, v1);
        if (!contains(v1, filter)){
            return;
        }
        log(v0+">>>"+v1);
        methodInBeat(invokeId, startTime, 'public static void com.tencent.component.utils.LogUtil.i(java.lang.String,java.lang.String)', executor);
    };

    
    var com_tencent_component_utils_LogUtil_clz_method_d_6sc6 = com_tencent_component_utils_LogUtil_clz.d.overload('java.lang.String', 'java.lang.String');
    com_tencent_component_utils_LogUtil_clz_method_d_6sc6.implementation = function(v0, v1) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        com_tencent_component_utils_LogUtil_clz_method_d_6sc6.call(com_tencent_component_utils_LogUtil_clz, v0, v1);
        if (!contains(v1, filter)){
            return;
        }
        log(v0+">>>"+v1);
        methodInBeat(invokeId, startTime, 'public static void com.tencent.component.utils.LogUtil.d(java.lang.String,java.lang.String)', executor);
    };
    
   
   
    var com_tencent_component_utils_LogUtil_clz_method_v_qn5k = com_tencent_component_utils_LogUtil_clz.v.overload('java.lang.String', 'java.lang.String');
    com_tencent_component_utils_LogUtil_clz_method_v_qn5k.implementation = function(v0, v1) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        com_tencent_component_utils_LogUtil_clz_method_v_qn5k.call(com_tencent_component_utils_LogUtil_clz, v0, v1);
        if (!contains(v1, filter)){
            return;
        }
        log(v0+">>>"+v1);
        methodInBeat(invokeId, startTime, 'public static void com.tencent.component.utils.LogUtil.v(java.lang.String,java.lang.String)', executor);
    };
   
    
    

    var com_tencent_component_utils_LogUtil_clz_method_w_90ky = com_tencent_component_utils_LogUtil_clz.w.overload('java.lang.String', 'java.lang.String');
    com_tencent_component_utils_LogUtil_clz_method_w_90ky.implementation = function(v0, v1) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        com_tencent_component_utils_LogUtil_clz_method_w_90ky.call(com_tencent_component_utils_LogUtil_clz, v0, v1);
        if (!contains(v1, filter)){
            return;
        }
        log(v0+">>>"+v1);
        methodInBeat(invokeId, startTime, 'public static void com.tencent.component.utils.LogUtil.w(java.lang.String,java.lang.String)', executor);
    };

   
    var com_tencent_component_utils_LogUtil_clz_method_e_8v5o = com_tencent_component_utils_LogUtil_clz.e.overload('java.lang.String', 'java.lang.String');
    com_tencent_component_utils_LogUtil_clz_method_e_8v5o.implementation = function(v0, v1) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        com_tencent_component_utils_LogUtil_clz_method_e_8v5o.call(com_tencent_component_utils_LogUtil_clz, v0, v1);
        if (!contains(v1, filter)){
            return;
        }
        log(v0+">>>"+v1);
        methodInBeat(invokeId, startTime, 'public static void com.tencent.component.utils.LogUtil.e(java.lang.String,java.lang.String)', executor);
    };
});