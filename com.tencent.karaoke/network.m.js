//com.tencent.karaoke.common.network.m:?
...
Java.perform(function() {
    ...
    //下面是生成的代码
    var com_tencent_karaoke_common_network_m_clz = Java.use('com.tencent.karaoke.common.network.m');
    var com_tencent_karaoke_common_network_m_clz_method_a_gl0q = com_tencent_karaoke_common_network_m_clz.a.overload('com.tencent.karaoke.common.network.i', 'int', 'java.lang.String');
    com_tencent_karaoke_common_network_m_clz_method_a_gl0q.implementation = function(v0, v1, v2) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        var ret = com_tencent_karaoke_common_network_m_clz_method_a_gl0q.call(this, v0, v1, v2);
        methodInBeat(invokeId, startTime, 'public boolean com.tencent.karaoke.common.network.m.a(com.tencent.karaoke.common.network.i,int,java.lang.String)', executor);
        return ret;
    };
    var com_tencent_karaoke_common_network_m_clz_method_a_we1j = com_tencent_karaoke_common_network_m_clz.a.overload('com.tencent.karaoke.common.network.i', 'com.tencent.karaoke.common.network.l');
    com_tencent_karaoke_common_network_m_clz_method_a_we1j.implementation = function(v0, v1) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        var ret = com_tencent_karaoke_common_network_m_clz_method_a_we1j.call(this, v0, v1);
        methodInBeat(invokeId, startTime, 'public boolean com.tencent.karaoke.common.network.m.a(com.tencent.karaoke.common.network.i,com.tencent.karaoke.common.network.l)', executor);
        return ret;
    };
    var com_tencent_karaoke_common_network_m_clz_method_a_f2dp = com_tencent_karaoke_common_network_m_clz.a.overload('com.tencent.karaoke.common.network.i', 'com.tencent.karaoke.common.network.j');
    com_tencent_karaoke_common_network_m_clz_method_a_f2dp.implementation = function(v0, v1) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        var ret = com_tencent_karaoke_common_network_m_clz_method_a_f2dp.call(this, v0, v1);
        methodInBeat(invokeId, startTime, 'public boolean com.tencent.karaoke.common.network.m.a(com.tencent.karaoke.common.network.i,com.tencent.karaoke.common.network.j)', executor);
        return ret;
    };
});