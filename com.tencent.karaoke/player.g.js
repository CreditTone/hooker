//com.tencent.karaoke.common.media.player.g:_
...
Java.perform(function() {
	...
	//下面是生成的代码
var com_tencent_karaoke_common_media_player_g_clz = Java.use('com.tencent.karaoke.common.media.player.g');var com_tencent_karaoke_common_media_player_g_clz_init_p7eh = com_tencent_karaoke_common_media_player_g_clz.$init.overload();com_tencent_karaoke_common_media_player_g_clz_init_p7eh.implementation = function() {var invokeId = Math.random().toString(36).slice( - 8);var startTime = new Date().getTime();var executor = this.hashCode();var obj = com_tencent_karaoke_common_media_player_g_clz_init_p7eh.call(this);methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.common.media.player.g()', executor);return obj;};});