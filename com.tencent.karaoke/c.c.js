//com.tencent.karaoke.common.KaraokeContext:getReporterContainer
...
Java.perform(function() {
    ...
    //下面是生成的代码
    var com_tencent_karaoke_common_KaraokeContext_clz = Java.use('com.tencent.karaoke.common.KaraokeContext');
    var com_tencent_karaoke_common_KaraokeContext_clz_method_getReporterContainer_ejou = com_tencent_karaoke_common_KaraokeContext_clz.getReporterContainer.overload();
    com_tencent_karaoke_common_KaraokeContext_clz_method_getReporterContainer_ejou.implementation = function() {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'Class';
        var ret = com_tencent_karaoke_common_KaraokeContext_clz_method_getReporterContainer_ejou.call(com_tencent_karaoke_common_KaraokeContext_clz);
        methodInBeat(invokeId, startTime, 'public static com.tencent.karaoke.common.reporter.newreport.a com.tencent.karaoke.common.KaraokeContext.getReporterContainer()', executor);
        return ret;
    };
});