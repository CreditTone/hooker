//com.tencent.karaoke.common.media.player.KaraPlayerService:_
...
Java.perform(function() {
	...
	//下面是生成的代码
var com_tencent_karaoke_common_media_player_KaraPlayerService_clz = Java.use('com.tencent.karaoke.common.media.player.KaraPlayerService');var com_tencent_karaoke_common_media_player_KaraPlayerService_clz_init_prg8 = com_tencent_karaoke_common_media_player_KaraPlayerService_clz.$init.overload();com_tencent_karaoke_common_media_player_KaraPlayerService_clz_init_prg8.implementation = function() {var invokeId = Math.random().toString(36).slice( - 8);var startTime = new Date().getTime();var executor = this.hashCode();var obj = com_tencent_karaoke_common_media_player_KaraPlayerService_clz_init_prg8.call(this);methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.common.media.player.KaraPlayerService()', executor);return obj;};});