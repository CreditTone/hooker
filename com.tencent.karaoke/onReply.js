//com.tencent.karaoke.module.searchglobal.b.a:onReply
...
Java.perform(function() {
    ...
    //下面是生成的代码
    var com_tencent_karaoke_module_searchglobal_b_a_clz = Java.use('com.tencent.karaoke.module.searchglobal.b.a');
    var com_tencent_karaoke_module_searchglobal_b_a_clz_method_onReply_zzfh = com_tencent_karaoke_module_searchglobal_b_a_clz.onReply.overload('com.tencent.karaoke.common.network.i', 'com.tencent.karaoke.common.network.j');
    com_tencent_karaoke_module_searchglobal_b_a_clz_method_onReply_zzfh.implementation = function(v0, v1) {
        var ret = com_tencent_karaoke_module_searchglobal_b_a_clz_method_onReply_zzfh.call(this, v0, v1);
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        logJSONString(v0.req.value);
        log("------------");
        logJSONString(v1.c());
        methodInBeat(invokeId, startTime, 'public boolean com.tencent.karaoke.module.searchglobal.b.a.onReply(com.tencent.karaoke.common.network.i,com.tencent.karaoke.common.network.j)', executor);
