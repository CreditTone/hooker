//com.tencent.karaoke.common.reporter.WorksReportObj:_
...
Java.perform(function() {
	...
	//下面是生成的代码
var com_tencent_karaoke_common_reporter_WorksReportObj_clz = Java.use('com.tencent.karaoke.common.reporter.WorksReportObj');var com_tencent_karaoke_common_reporter_WorksReportObj_clz_init_tz2h = com_tencent_karaoke_common_reporter_WorksReportObj_clz.$init.overload();com_tencent_karaoke_common_reporter_WorksReportObj_clz_init_tz2h.implementation = function() {var invokeId = Math.random().toString(36).slice( - 8);var startTime = new Date().getTime();var executor = this.hashCode();var obj = com_tencent_karaoke_common_reporter_WorksReportObj_clz_init_tz2h.call(this);methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.common.reporter.WorksReportObj()', executor);return obj;};});