//com.tencent.karaoke.module.vod.newvod.report.a:_
...
Java.perform(function() {
    ...
    var com_tencent_karaoke_module_vod_newvod_report_a_clz_init_jn3l = com_tencent_karaoke_module_vod_newvod_report_a_clz.$init.overload('java.lang.String');
    com_tencent_karaoke_module_vod_newvod_report_a_clz_init_jn3l.implementation = function(v0) {
        var obj = com_tencent_karaoke_module_vod_newvod_report_a_clz_init_jn3l.call(this, v0);
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        log(v0);
        methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.module.vod.newvod.report.a(java.lang.String)', executor);
