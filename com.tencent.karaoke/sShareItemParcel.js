//com.tencent.karaoke.module.share.business.ShareItemParcel:_
...
Java.perform(function() {
	...
	//下面是生成的代码
var com_tencent_karaoke_module_share_business_ShareItemParcel_clz = Java.use('com.tencent.karaoke.module.share.business.ShareItemParcel');var com_tencent_karaoke_module_share_business_ShareItemParcel_clz_init_mgoa = com_tencent_karaoke_module_share_business_ShareItemParcel_clz.$init.overload();com_tencent_karaoke_module_share_business_ShareItemParcel_clz_init_mgoa.implementation = function() {var obj = com_tencent_karaoke_module_share_business_ShareItemParcel_clz_init_mgoa.call(this);var invokeId = Math.random().toString(36).slice( - 8);var startTime = new Date().getTime();var executor = this.hashCode();methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.module.share.business.ShareItemParcel()', executor);methodOutBeat(invokeId, startTime);return obj;};});