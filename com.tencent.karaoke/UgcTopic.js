...
Java.perform(function() {
	...
	//下面是生成的代码
var PROTO_UGC_WEBAPP_UgcTopic_clz = Java.use('PROTO_UGC_WEBAPP.UgcTopic');var PROTO_UGC_WEBAPP_UgcTopic_clz_init_bt8t = PROTO_UGC_WEBAPP_UgcTopic_clz.$init.overload();PROTO_UGC_WEBAPP_UgcTopic_clz_init_bt8t.implementation = function() {var obj = PROTO_UGC_WEBAPP_UgcTopic_clz_init_bt8t.call(this);var invokeId = Math.random().toString(36).slice( - 8);var startTime = new Date().getTime();var executor = this.hashCode();methodInBeat(invokeId, startTime, 'public PROTO_UGC_WEBAPP.UgcTopic()', executor);methodOutBeat(invokeId, startTime);return obj;};});