//com.tencent.karaoke.module.share.business.e:getShareUrl
...
Java.perform(function() {
    ...
    //下面是生成的代码
    var com_tencent_karaoke_module_share_business_e_clz = Java.use('com.tencent.karaoke.module.share.business.e');
    var com_tencent_karaoke_module_share_business_e_clz_method_getShareUrl_ay7y = com_tencent_karaoke_module_share_business_e_clz.getShareUrl.overload('java.lang.String');
    com_tencent_karaoke_module_share_business_e_clz_method_getShareUrl_ay7y.implementation = function(v0) {
        var ret = com_tencent_karaoke_module_share_business_e_clz_method_getShareUrl_ay7y.call(this, v0);
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        log(v0);
        methodInBeat(invokeId, startTime, 'public java.lang.String com.tencent.karaoke.module.share.business.e.getShareUrl(java.lang.String)', executor);
