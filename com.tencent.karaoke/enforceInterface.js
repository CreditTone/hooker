...
Java.perform(function() {
    ...
    var android_os_Parcel_clz_method_enforceInterface_y4jh = android_os_Parcel_clz.enforceInterface.overload('java.lang.String');
    android_os_Parcel_clz_method_enforceInterface_y4jh.implementation = function(v0) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'obj:' + this.hashCode();
        log(v0);
        android_os_Parcel_clz_method_enforceInterface_y4jh.call(this, v0);
        methodInBeat(invokeId, startTime, 'public final void android.os.Parcel.enforceInterface(java.lang.String)', executor);
    };
});