//com.tencent.karaoke.common.media.OpusInfo:_
...
Java.perform(function() {
    ...
    //下面是生成的代码
    var com_tencent_karaoke_common_media_OpusInfo_clz = Java.use('com.tencent.karaoke.common.media.OpusInfo');
    var com_tencent_karaoke_common_media_OpusInfo_clz_init_j7dj = com_tencent_karaoke_common_media_OpusInfo_clz.$init.overload();
    com_tencent_karaoke_common_media_OpusInfo_clz_init_j7dj.implementation = function() {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        var obj = com_tencent_karaoke_common_media_OpusInfo_clz_init_j7dj.call(this);
        methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.common.media.OpusInfo()', executor);
        return obj;
    };
    var inits = com_tencent_karaoke_common_media_OpusInfo_clz.$init.overloads;
  ...
  function getObjectKeys(object)
  {
    ...
    //log(getObjectKeys(inits[2]));
    // log(inits[2]._p);
    // log(inits[2].methodName);
    // log(inits[2].holder);
    // log(inits[2].type);
    // log(inits[2].handle);
    // log(inits[2].implementation);
    // log(inits[2].returnType);
    // log((inits[2].argumentTypes.length));
    // var arg = inits[2].argumentTypes[0];
    // log(getObjectKeys(arg));
    // log((arg.className));
    // log((arg.name));
    // log((arg.type));
    //var com_tencent_karaoke_common_media_OpusInfo_clz_init_fa8p = com_tencent_karaoke_common_media_OpusInfo_clz.$init.overload('java.lang.String', 'java.lang.String', 'java.lang.String', 'java.lang.String', 'java.lang.String', 'long', 'long', 'java.lang.String', 'int', 'java.lang.String', 'int', 'java.lang.String', 'int');
    inits[1].implementation = function(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        var obj = inits[1].call(this, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12);
        methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.common.media.OpusInfo(java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String,long,long,java.lang.String,int,java.lang.String,int,java.lang.String,int)', executor);
        return obj;
    };
    //var com_tencent_karaoke_common_media_OpusInfo_clz_init_ytwu = com_tencent_karaoke_common_media_OpusInfo_clz.$init.overload('java.lang.String', 'java.lang.String', 'java.lang.String', 'java.lang.String', 'java.lang.String', 'long', 'long', 'java.lang.String', 'int', 'java.lang.String', 'int', 'java.lang.String', 'java.lang.String', '[Lbyte;', 'java.util.Map', 'int');
    inits[2].implementation = function(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        var obj = inits[2].call(this, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15);
        methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.common.media.OpusInfo(java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String,long,long,java.lang.String,int,java.lang.String,int,java.lang.String,java.lang.String,byte[],java.util.Map,int)', executor);
        return obj;
    };
    //var com_tencent_karaoke_common_media_OpusInfo_clz_init_6jsp = com_tencent_karaoke_common_media_OpusInfo_clz.$init.overload('java.lang.String', 'java.lang.String', 'java.lang.String', 'java.lang.String', 'java.lang.String', 'long', 'long', 'java.lang.String', 'int', 'java.lang.String', 'int', 'java.lang.String', 'java.lang.String', '[Lbyte;', 'java.util.Map', 'int', 'int', 'java.lang.String');
    inits[3].implementation = function(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17) {
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = this.hashCode();
        var obj = inits[3].call(this, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17);
        methodInBeat(invokeId, startTime, 'public com.tencent.karaoke.common.media.OpusInfo(java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String,long,long,java.lang.String,int,java.lang.String,int,java.lang.String,java.lang.String,byte[],java.util.Map,int,int,java.lang.String)', executor);
        return obj;
    };
});