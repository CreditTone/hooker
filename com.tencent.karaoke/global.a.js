//com.tencent.karaoke.module.searchglobal.b.a.a:a
...
Java.perform(function() {
    ...
    //下面是生成的代码
    var com_tencent_karaoke_module_searchglobal_b_a_a_clz = Java.use('com.tencent.karaoke.module.searchglobal.b.a.a');
    var com_tencent_karaoke_module_searchglobal_b_a_a_clz_method_a_6ega = com_tencent_karaoke_module_searchglobal_b_a_a_clz.a.overload('proto_ugc_search.SearchUgcGroupContent');
    com_tencent_karaoke_module_searchglobal_b_a_a_clz_method_a_6ega.implementation = function(v0) {
        logJSONString(v0);
        var ret = com_tencent_karaoke_module_searchglobal_b_a_a_clz_method_a_6ega.call(com_tencent_karaoke_module_searchglobal_b_a_a_clz, v0);
        var invokeId = Math.random().toString(36).slice( - 8);
        var startTime = new Date().getTime();
        var executor = 'com_tencent_karaoke_module_searchglobal_b_a_a_clz';
        methodInBeat(invokeId, startTime, 'public static java.util.ArrayList com.tencent.karaoke.module.searchglobal.b.a.a.a(proto_ugc_search.SearchUgcGroupContent)', executor);
