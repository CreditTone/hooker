...
//okhttp3.internal.h.e:verify
Java.perform(function() {
    var okhttp3_internal_h_e_clz = Java.use('okhttp3.internal.h.e');
    var okhttp3_internal_h_e_clz_method_verify_1701 = okhttp3_internal_h_e_clz.verify.overload('java.lang.String', 'javax.net.ssl.SSLSession');
    okhttp3_internal_h_e_clz_method_verify_1701.implementation = function(v0, v1) {
        var executor = this.hashCode();
        var beatText = 'public boolean okhttp3.internal.h.e.verify(java.lang.String,javax.net.ssl.SSLSession)';
        var beat = newMethodBeat(beatText, executor);
        var ret = okhttp3_internal_h_e_clz_method_verify_1701.call(this, v0, v1);
        printBeat(beat);
        log("domain:"+v0+" ret:"+ret);
        return ret;
    };
    var okhttp3_internal_h_e_clz_method_verify_5706 = okhttp3_internal_h_e_clz.verify.overload('java.lang.String', 'java.security.cert.X509Certificate');
    okhttp3_internal_h_e_clz_method_verify_5706.implementation = function(v0, v1) {
        var executor = this.hashCode();
        var beatText = 'public boolean okhttp3.internal.h.e.verify(java.lang.String,java.security.cert.X509Certificate)';
        var beat = newMethodBeat(beatText, executor);
        var ret = okhttp3_internal_h_e_clz_method_verify_5706.call(this, v0, v1);
        printBeat(beat);
        log("domain2:"+v0+" ret:"+ret);
        return ret;
    };
});