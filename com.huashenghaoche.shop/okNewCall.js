...
Java.perform(function() {
    ...
    var okhttp3_aa_clz = Java.use('okhttp3.aa');
    var okhttp3_aa_clz_method_newCall_3326 = okhttp3_aa_clz.newCall.overload('okhttp3.ad');
    okhttp3_aa_clz_method_newCall_3326.implementation = function(v0) {
        var executor = this.hashCode();
        var beatText = 'public okhttp3.e okhttp3.aa.newCall(okhttp3.ad)';
        var beat = newMethodBeat(beatText, executor);
        var ret = okhttp3_aa_clz_method_newCall_3326.call(this, v0);
        //console.log("ssl socket factory:" + getClassName(this.o.value));
        log("url:"+v0.a.value.toString());
        printBeat(beat);
        //ObjectsStore.storeObject(this)
        //log("storeObject okhttpcient:" + ObjectsStore.storeObject(this));
        return ret;
    };
});