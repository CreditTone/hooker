...
Java.perform(function() {
    ...
    okhttp3_OkHttpClient_clz_method_newCall_8095.implementation = function(v0) {
        ...
        log("hook the object hashCode:" + executor);
        var beatText = 'public okhttp3.Call okhttp3.OkHttpClient.newCall(okhttp3.Request)';
        var beat = newMethodBeat(beatText, executor);
        var ret = null;
        
        ret = okhttp3_OkHttpClient_clz_method_newCall_8095.call(this, v0);
        printBeat(beat);
        return ret;
    };
});