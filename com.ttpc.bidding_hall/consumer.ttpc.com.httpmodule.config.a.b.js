...
//consumer.ttpc.com.httpmodule.config.a:b
...
//consumer.ttpc.com.httpmodule.config.a:b
Java.perform(function() {
    var consumer_ttpc_com_httpmodule_config_a_clz = Java.use('consumer.ttpc.com.httpmodule.config.a');
    var consumer_ttpc_com_httpmodule_config_a_clz_method_b_4432 = consumer_ttpc_com_httpmodule_config_a_clz.b.overload('java.lang.String', 'java.lang.String');
    consumer_ttpc_com_httpmodule_config_a_clz_method_b_4432.implementation = function(v0, v1) {
        if (v0 == "request") {
            log("v1:"+getPrettyString(v1));
            var executor = 'Class';
            var beatText = 'public static void consumer.ttpc.com.httpmodule.config.a.b(java.lang.String,java.lang.String)';
            var beat = newMethodBeat(beatText, executor);
            consumer_ttpc_com_httpmodule_config_a_clz_method_b_4432.call(consumer_ttpc_com_httpmodule_config_a_clz, v0, v1);
            printBeat(beat);
        }
    };
});