...
function toJsonObject(objectId) {
	var radarPropertiesClz = Java.use("gz.radar.RadarProperties");
	var obj = radarPropertiesClz.getCachedObject(objectId+"");
	if (obj) {
		log(fastTojson(obj));
	}else{
...
function toStringObject(objectId) {
	var radarPropertiesClz = Java.use("gz.radar.RadarProperties");
	var obj = radarPropertiesClz.getCachedObject(objectId+"");
	if (obj) {
		log(obj.toString());
