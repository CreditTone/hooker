//crack by com.miui.screenrecorder 1.5.9
//com.miui.screenrecorder.StableScreenRecorder:setAudioSource
...
function loadXinitDexfile(dexfile) {
    loadDexfile('/data/user/0/com.miui.screenrecorder/xinit/'+dexfile);
};

function loadXRadarDexfile() {
    loadDexfile('/data/user/0/com.miui.screenrecorder/radar.dex');
};
...
//com.miui.screenrecorder.StableScreenRecorder:setAudioSource
Java.perform(function() {
    var com_miui_screenrecorder_StableScreenRecorder_clz = Java.use('com.miui.screenrecorder.StableScreenRecorder');
    var com_miui_screenrecorder_StableScreenRecorder_clz_method_setAudioSource_yeub = com_miui_screenrecorder_StableScreenRecorder_clz.setAudioSource.overload('int');
    com_miui_screenrecorder_StableScreenRecorder_clz_method_setAudioSource_yeub.implementation = function(v0) {
        log(v0);
        var executor = this.hashCode();
        var beatText = 'public void com.miui.screenrecorder.StableScreenRecorder.setAudioSource(int)';
        var beat = newMethodBeat(beatText, executor);
        com_miui_screenrecorder_StableScreenRecorder_clz_method_setAudioSource_yeub.call(this, v0);
        printBeat(beat);
    };
});