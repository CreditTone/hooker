//dalvik.system.DexClassLoader:_
...
Java.perform(function() {
	...
	//下面是生成的代码
var dalvik_system_DexClassLoader_clz = Java.use('dalvik.system.DexClassLoader');var dalvik_system_DexClassLoader_clz_init_ymcm = dalvik_system_DexClassLoader_clz.$init.overload('java.lang.String','java.lang.String','java.lang.String','java.lang.ClassLoader');dalvik_system_DexClassLoader_clz_init_ymcm.implementation = function(v0,v1,v2,v3) {var invokeId = Math.random().toString(36).slice( - 8);var startTime = new Date().getTime();var executor = this.hashCode();var obj = dalvik_system_DexClassLoader_clz_init_ymcm.call(this,v0,v1,v2,v3);methodInBeat(invokeId, startTime, 'public dalvik.system.DexClassLoader(java.lang.String,java.lang.String,java.lang.String,java.lang.ClassLoader)', executor);return obj;};});