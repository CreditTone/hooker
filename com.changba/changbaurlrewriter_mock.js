...
function encrypt(src) {
    var ret = "";
    Java.perform(function() {
        var EncryptMocker = Java.use('gz.changba.EncryptMocker');
...
function startWebServer() {
    ...
    Java.perform(function() {
        var networkEncryptMockerClz = Java.use('gz.changba.NetworkEncryptMocker');
...
checkLoadDex("gz.changba.NetworkEncryptMocker", "/data/local/tmp/com.changba/spider.dex");
